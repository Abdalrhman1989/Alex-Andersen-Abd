...
namespace AAO_App
{
    public class HomepageController : Controller
    {
        ...
        public ActionResult Index(TripModelView model)
        {
            ...
            ViewBag.driverHasTrip  = (from t in _context.Trips
            ...
            ViewBag.profileImage = _context.Drivers.Find(int.Parse(this.HttpContext.Session.GetString("DriverId")))?.ProfileImage;
